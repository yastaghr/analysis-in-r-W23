...
get.r.squared.total <- function(est.bi, actual.bi) {
    ...
    if (length(xover)>1) {
        ...
        act.resid.sq <- get.v.resid.squared(act.zv);
        return(act.resid.sq)
    }
